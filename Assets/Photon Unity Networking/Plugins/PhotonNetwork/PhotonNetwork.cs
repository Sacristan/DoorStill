...
public static class PhotonNetwork
{
    ...
    private static int sendIntervalOnSerialize = 50;
    ...
    public static void CreateRoom(string roomName)
    {
        ...
        else
        {
            ...
            {
                networkingPeer.OpCreateGame(roomName, true, true);
            }
        }
    }
    ...
    public static void CreateRoom(string roomName, bool isVisible, bool isOpen, byte maxPlayers)
    {
        ...
        else
        {
            ...
            {
                networkingPeer.OpCreateGame(roomName, isVisible, isOpen, (byte)maxPlayers);
            }
        }
    }
    ...
    {
        PhotonView[] views = go.GetComponents<PhotonView>();
        ...
        {
            Debug.LogError("Destroy: Could not destroy gameobject " + go + ", it has no PhotonViews attached!");
        }
    }
