...
public class PhotonEditor : EditorWindow
{
    ...
    const string UrlCompare = "http://exitgames.com/CloudVsOwnHost";
    ...
    const string UrlAccountPage = "http://exitgamescloud.com/Account/LogOn?email=";
    const string UrlAppIDExplained = "http://exitgames.com/CloudVsOwnHost";


    Vector2 scrollPos = Vector2.zero;

    enum GUIState { Main, Setup }
    ...
    void RegisterWithEmail(string email)
    {
        ...
        Result result = new Result() { ReturnCode = -1, Message = "Account Service not available. Please use web-access and 'manual' setup." };
