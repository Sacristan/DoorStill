    ...
    static string ConvertToPhotonAPI(string file, string input)
    {
        ...
        //Network
        {
            //Monobehaviour callbacks
            {
                ...
                input = PregReplace(input, NOT_VAR_WITH_DOT + "OnPlayerDisconnected" + NOT_VAR_WITH_DOT, "$1OnPhotonPlayerDisconneced$2");
            ...
            //Variables
            {
                ...
                input = PregReplace(input, NOT_VAR_WITH_DOT + "Network.isClient" + NOT_VAR_WITH_DOT, "$1PhotonNetwork.isNonMasterClientInGame$2");
                ...
                input = PregReplace(input, NOT_VAR_WITH_DOT + "ConnectionState.Client" + NOT_VAR_WITH_DOT, "$1PhotonNetwork.isNonMasterClientInGame$2");
