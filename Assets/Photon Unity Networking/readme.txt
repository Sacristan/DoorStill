...
Server
	Exit Games is running Photon as service. This is currently free of charge.
	The window "Photon Unity Networking" will help you setup an account.
	Within Exitgames Cloud, the server cannot be modified.
